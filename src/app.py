...
activities = {
    ...
    "Music Ensemble": {
        "description": "Perform in orchestras and jazz bands",
        "schedule": "Mondays and Fridays, 4:00 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["alex@mergington.edu", "natalie@mergington.edu", "marcus@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Science Club": {
        "description": "Conduct experiments and explore advanced science topics",
        "schedule": "Thursdays, 3:30 PM - 4:45 PM",
        "max_participants": 22,
        "participants": ["grace@mergington.edu", "thomas@mergington.edu", "isabella@mergington.edu"]
    }
}
